            ...
            msg: to_json_binary(&nod::msg::ExecuteMsg::Submit {
                ...
                extension: Box::new(nod::msg::SubmitExtension {
                    entity: nod::msg::NodEntity {
                        ...
                        floor_rate: Uint128::new(240000000000000000),
                        nominal_price_minor: tribute.extension.nominal_qty_minor,
                        issuance_price_minor: exchange_rate.atomics(),
                        gratis_load_minor: tribute.extension.symbolic_load,
                        floor_price_minor: floor_price.atomics(),
        ...
        msg: to_json_binary(&nod::msg::ExecuteMsg::Submit {
            ...
            extension: Box::new(nod::msg::SubmitExtension {
                entity: nod::msg::NodEntity {
                    ...
                    floor_rate: Uint128::new(240000000000000000),
                    nominal_price_minor: winner.data.nominal_qty_minor,
                    issuance_price_minor: exchange_rate.atomics(),
                    gratis_load_minor: allocation,
                    floor_price_minor: exchange_rate.atomics(),
                    state: nod::types::State::Issued,
                    owner: winner.owner.to_string(),
                    qualified_at: None,
                },

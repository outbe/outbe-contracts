...
const CONTRACT_NAME: &str = "outbe.net:randao";
...
pub fn instantiate(
    ...
    SEED.save(deps.storage, &msg.seed)?;

    Ok(Response::default()
        .add_attribute("action", "randao::instantiate")
        .add_event(Event::new("randao::instantiate").add_attribute("creator", creator)))
}
